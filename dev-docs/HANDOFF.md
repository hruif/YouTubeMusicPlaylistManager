...
- **Two coexisting apps:** the original **Python/Tkinter** app at the root (described below), and the
  ...
  (release `desktop-v0.3.0`, universal `.dmg`). For the desktop app see `desktop/README.md`,
  `desktop/BUILD.md`, and the desktop entry in `STATUS.md`. The rest of this handoff is about the
  **Python** app.
